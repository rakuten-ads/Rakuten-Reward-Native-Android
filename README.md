...
|---------|-------------|-------------|
| 8.0.0   | API24 (7.0) | API 36      |
| 7.5.1   | API24 (7.0) | API 35      |
...
dependencies {
  ...
  implementation platform('com.rakuten.android:rewardsdknative-bom:8.0.0')
...
[KDoc](https://rakuten-ads.github.io/products/mission/android/kdoc/8.0.0/index.html)  
